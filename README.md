...
## Methodology
 My research follows a multi-stage pipeline to ensure every finding is high-signal and actionable.
  ...
  3: **Exploit Pathing:** This is the creative phase. Once an anomaly is flagged, I try and map out potential exploit chains, determining if a leak leads to SSRF, if a header allows for SSO smuggling, or if a hardcoded key grants unauthorized data access.
